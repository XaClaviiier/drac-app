...
export const helpArticles: HelpArticle[] = [
  ...
  },
  {
    ...
    sections: [
      { title: "Alur kerja", steps: ["Buat WO dengan memilih pelanggan, kendaraan, keluhan, cabang, dan waktu kedatangan.", "Saat Register, lakukan pemeriksaan dan tambahkan layanan atau barang beserta estimasinya.", "Pada tab Info lainnya, pilih Teknisi Utama, tambahkan Teknisi Pendamping bila ada, lalu pisahkan Komentar/Diagnosis Keluhan dari Hasil Kerja.", "Setelah pelanggan menyetujui pekerjaan dan harga, ubah menjadi Dikerjakan.", "Tambahkan pekerjaan aktual bila diperlukan, isi Hasil Kerja, lalu tandai Selesai.", "Buat faktur berdasarkan pekerjaan dan barang final. Faktur serta pembayaran terkait dapat diperiksa pada tab Pembayaran WO."] },
      { title: "Aturan", rules: ["Keluhan wajib dipilih sebelum WO dibuat.", "Status Dikerjakan memerlukan minimal satu layanan/barang, estimasi lebih dari Rp0, dan Teknisi Utama.", "WO Selesai wajib memiliki hasil pengukuran lengkap atau Hasil Kerja; Keterangan Internal tidak menggantikannya.", "WO tidak memotong stok. Stok barang berkurang ketika faktur penjualan dibuat.", "Status pekerjaan dan status pembayaran adalah dua hal terpisah.", "Tab Pembayaran hanya menampilkan transaksi faktur dan pembayaran yang benar-benar tercatat pada ledger."] },
      { title: "Perlu Tindakan", steps: ["Klik lonceng di header atau pilih Butuh Tindakan pada Filter Order Kerja.", "Selesaikan Register Mengambang menjadi Dikerjakan atau Lost Sales.", "Tuntaskan pekerjaan Dikerjakan Terlambat.", "Buat faktur untuk WO yang sudah Selesai.", "Proses pembayaran untuk faktur yang belum lunas."], rules: ["Register hanya antrean sementara pada hari transaksi dan tidak boleh dibiarkan mengambang setelah hari berganti.", "Sistem tidak mengubah Register menjadi Lost Sales secara otomatis; pengguna wajib memilih hasil sebenarnya agar histori tetap akurat.", "Segitiga kuning menandai tindak lanjut administrasi dan tanda seru merah menandai keterlambatan operasional.", "Badge lonceng, filter, dan kolom Perhatian memakai sumber perhitungan yang sama serta mengikuti cabang aktif."] },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Nomor faktur dan nota fisik", rules: ["Nomor faktur sistem dibuat otomatis dan tidak dapat diganti agar jejak audit tetap berurutan.", "No. Nota Fisik boleh dikosongkan atau diisi sesuai nomor pada nota fisik asli.", "No. Nota Fisik yang diisi wajib unik untuk seluruh faktur; nomor yang sudah dipakai akan ditolak.", "No. Nota Fisik dapat dicari, ditampilkan pada rincian, dan ikut tercantum saat faktur dibagikan."] },
      ...
      { title: "Aturan stok negatif baku", rules: ["Faktur penjualan tetap boleh disimpan ketika stok gudang nol atau kurang karena barang fisik mungkin sudah dipasang sementara penerimaannya belum dicatat.", "Sistem menampilkan saldo saat ini dan perkiraan saldo setelah faktur sebagai peringatan, bukan sebagai pemblokir transaksi.", "Penerimaan yang terlambat harus dicatat ke barang dan gudang yang sama dengan tanggal dokumen sebenarnya agar saldo dan kartu stok kembali benar.", "Stok minus wajib muncul pada laporan Stok Kosong/Minus dan segera ditindaklanjuti; jangan membuat penyesuaian fiktif hanya untuk menghilangkan angka minus.", "Transfer gudang, pembatalan dokumen, dan penyesuaian persediaan tetap memakai kontrol saldo serta otorisasi karena merupakan transaksi pengendalian stok."] },
      { title: "Aturan koreksi baku Accurate", rules: ["Faktur yang sudah memiliki pembayaran atau retur tidak dapat dihapus; hapus transaksi turunannya terlebih dahulu.", "Setelah faktur dihapus, faktur hilang dari daftar dan mutasi aktif barang, stok dikembalikan, serta relasi faktur dari WO dilepas.", "Snapshot faktur, pengguna, waktu, dan alasan penghapusan tetap tersimpan di Log Aktivitas administrator.", "WO tetap tersimpan sebagai histori pekerjaan Selesai."] },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      { title: "Alur kerja", steps: ["Buat Penerimaan Barang ketika barang tiba di gudang.", "Jika barang belum ada, pilih Barang belum ada lalu isi Nama Barang, Kode Barcode/Kode Barang Asli bila tersedia, Kategori, Merek Barang, dan Satuan resmi.", "Pada Info lainnya, tambahkan minimal satu kecocokan kendaraan melalui Merek, Tipe/Model, Generasi, pilihan CC, dan Jenis Mesin. Pilih Universal bila barang berlaku untuk semua mobil.", "Setelah memilih barang, lengkapi modal Rincian Barang: kuantitas, satuan, harga, diskon, kategori/merek, ringkasan kecocokan, dan petugas/teknisi. Tombol Lanjut baru memasukkan barang ke tabel.", "Gunakan Info lainnya untuk mengatur kecocokan kendaraan serta Keterangan; gunakan Penangguhan untuk rincian yang memerlukan tindak lanjut.", "Periksa gudang dan jumlah fisik, lalu terima barang agar stok bertambah.", "Buat Faktur Pembelian dari penerimaan terkait; harga dan diskon penerimaan menjadi nilai awal faktur.", "Catat pembayaran supplier sebagian atau lunas."] },
      { title: "Tanda terima digital", steps: ["Buka dokumen Penerimaan Barang yang sudah berstatus Diterima, Sebagian, atau Difakturkan.", "Buka menu Dokumen lalu pilih Simpan Gambar untuk mengunduh tanda terima PNG.", "Pilih Bagikan Gambar pada HP untuk membuka menu Share perangkat dan mengirim gambar melalui WhatsApp atau aplikasi lain.", "Pilih Print Bluetooth 80 mm untuk membuka dialog cetak; pasangkan printer Bluetooth melalui pengaturan HP atau layanan printer terlebih dahulu."], rules: ["Dokumen Draft dan Batal tidak dapat diterbitkan sebagai tanda terima resmi.", "Tanda terima berisi nomor dokumen, tanggal, gudang, sumber/supplier, penerima, barang, jumlah, keterangan, dan ruang tanda tangan.", "Print Bluetooth memakai dialog cetak perangkat agar kompatibel dengan printer thermal yang tersedia; aplikasi tidak menyimpan atau mengakses PIN Bluetooth."] },
      { title: "Aturan kecocokan kendaraan", rules: ["Urutan baku adalah Merek, Tipe/Model, Generasi, CC, lalu Jenis Mesin.", "Semua Tipe, Semua Generasi, Semua CC, dan Semua Mesin berarti barang berlaku untuk seluruh pilihan di bawah tingkat tersebut.", "Satu barang boleh mempunyai beberapa kecocokan. Contoh: TOYOTA — AVANZA — ALL NEW — Semua CC — Bensin.", "CC harus berasal dari Master Kendaraan; jangan mengetik variasi CC secara bebas di transaksi.", "Pilihan jenis mesin yang baku adalah Bensin, Diesel, Hybrid, dan Listrik."] },
      { title: "Aturan", rules: ["Barang baru dari penerimaan disimpan sebagai Menunggu Verifikasi; gunakan Universal / Semua Mobil hanya bila barang memang tidak khusus kendaraan tertentu.", "Satuan menggunakan pilihan baku PCS, SET, CAN, BOTOL, LITER, JASA, UNIT, atau PAKET.", "Barcode bersifat opsional dan tidak menggantikan kode barang otomatis.", "Jika nama barang sudah ada, pilih barang lama agar master dan stok tidak terduplikasi.", "Penerimaan yang sudah difakturkan tidak dapat diedit atau dihapus.", "Untuk koreksi, hapus pembayaran supplier, lalu faktur pembelian, kemudian penerimaan barang.", "Menghapus penerimaan yang belum difakturkan mengoreksi stok otomatis."] },
    ],
  },
  {
    ...
    sections: [
      ...
      { title: "Kontrol wajib", rules: ["Setiap mutasi harus mempunyai nomor urut, tanggal efektif, waktu pencatatan, barang, gudang, kuantitas, jenis transaksi, nomor dokumen, dan pembuat.", "Stok dilihat per gudang; angka Semua Cabang merupakan hasil agregasi, bukan gudang tersendiri.", "Saldo real-time disimpan per barang dan gudang, sedangkan Mutasi aktif dapat direkonsiliasi terhadap saldo.", "Edit tanggal, keterangan, petugas, cara pengiriman, atau header lain tidak mengubah kuantitas stok dan tidak membuat mutasi baru; perubahan tanggal hanya memperbarui tanggal efektif pada mutasi aktif yang sama.", "Jika faktur penjualan atau penerimaan yang belum memiliki transaksi turunan dihapus, dokumen dan mutasinya tidak lagi tampil; stok dikembalikan dan snapshot penghapusan disimpan di Log Aktivitas.", "Transfer dan Penyesuaian Posted tetap memakai Batalkan serta mutasi pembalik karena merupakan dokumen kontrol gudang.", "Gudang yang masih mempunyai saldo atau dokumen terbuka tidak dapat dinonaktifkan.", "Koreksi dimulai dari dokumen paling akhir agar hubungan sumber dan turunan tetap konsisten.", "Sesudah koreksi, cocokkan Stok per Gudang, Kartu Stok/Mutasi, serta laporan terkait."] },
  ...
  },
  {
    ...
    updatedAt: "20 Agustus 2026",
    sections: [
      { title: "Prinsip", paragraphs: ["Faktur Penjualan dan Penerimaan Barang dapat dihapus setelah pembayaran, retur, atau faktur turunannya dilepas; dokumen serta mutasi aktifnya hilang, stok kembali, dan snapshot tetap tercatat di Log Aktivitas. Penyesuaian Persediaan memakai aksi Hapus langsung: dokumen dan mutasinya dihapus, saldo stok dikoreksi otomatis tanpa membuat mutasi pembalik. Untuk dokumen lama berstatus Dibatalkan, penghapusan tidak mengoreksi stok lagi. Sistem memeriksa kecocokan mutasi dan ketersediaan stok sebelum menghapus. Riwayat penghapusan tetap tersimpan untuk audit. Penyesuaian yang terkait Hasil Stok Opname tidak dapat dihapus. Transfer Gudang tetap mengikuti alur pembatalannya."] },
