...
export const helpArticles: HelpArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Kontrol wajib", rules: ["Setiap mutasi harus mempunyai nomor urut, tanggal efektif, waktu pencatatan, barang, gudang, kuantitas, jenis transaksi, nomor dokumen, dan pembuat.", "Stok dilihat per gudang; angka Semua Cabang merupakan hasil agregasi, bukan gudang tersendiri.", "Saldo real-time disimpan per barang dan gudang, sedangkan Mutasi menjadi jejak audit yang dapat direkonsiliasi terhadap saldo.", "Edit keterangan, petugas, dan cara pengiriman tidak membuat mutasi stok baru.", "Perubahan barang, kuantitas, gudang, tanggal, atau status pada dokumen yang sudah memengaruhi stok dicatat sebagai kelompok koreksi dengan mutasi pembalik tertaut.", "Dokumen Draft boleh diedit atau dihapus. Dokumen Posted tidak dihapus; batalkan dengan mutasi pembalik dan alasan.", "Gudang yang masih mempunyai saldo atau dokumen terbuka tidak dapat dinonaktifkan.", "Koreksi dimulai dari dokumen paling akhir agar hubungan sumber dan turunan tetap konsisten.", "Sesudah koreksi, cocokkan Stok per Gudang, Kartu Stok/Mutasi, serta laporan terkait."] },
