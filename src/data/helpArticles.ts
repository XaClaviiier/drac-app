...
export const helpArticles: HelpArticle[] = [
  ...
  },
  {
    ...
    updatedAt: "20 Agustus 2026",
    sections: [
      { title: "Cara membuat", steps: ["Buka WO berstatus Selesai.", "Periksa pelanggan, kendaraan, tanggal, layanan, barang, harga, dan diskon.", "Simpan faktur.", "Catat pembayaran sekarang atau biarkan sebagai piutang."] },
      { title: "Dampak", paragraphs: ["Saat faktur dibuat, barang persediaan mengurangi stok cabang. Jasa tidak memengaruhi stok."] },
