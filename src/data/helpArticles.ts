...
export const helpArticles: HelpArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Kontrol wajib", rules: ["Setiap mutasi harus mempunyai nomor urut, tanggal efektif, waktu pencatatan, barang, gudang, kuantitas, jenis transaksi, nomor dokumen, dan pembuat.", "Stok dilihat per gudang; angka Semua Cabang merupakan hasil agregasi, bukan gudang tersendiri.", "Saldo real-time disimpan per barang dan gudang, sedangkan Mutasi aktif dapat direkonsiliasi terhadap saldo.", "Edit keterangan, petugas, dan cara pengiriman tidak membuat mutasi stok baru.", "Jika faktur penjualan atau penerimaan yang belum memiliki transaksi turunan dihapus, dokumen dan mutasinya tidak lagi tampil; stok dikembalikan dan snapshot penghapusan disimpan di Log Aktivitas.", "Transfer dan Penyesuaian Posted tetap memakai Batalkan serta mutasi pembalik karena merupakan dokumen kontrol gudang.", "Gudang yang masih mempunyai saldo atau dokumen terbuka tidak dapat dinonaktifkan.", "Koreksi dimulai dari dokumen paling akhir agar hubungan sumber dan turunan tetap konsisten.", "Sesudah koreksi, cocokkan Stok per Gudang, Kartu Stok/Mutasi, serta laporan terkait."] },
