...
export const helpArticles: HelpArticle[] = [
  ...
  },
  {
    ...
    updatedAt: "20 Agustus 2026",
    sections: [
      { title: "Prinsip", paragraphs: ["Aturan koreksi mengikuti jenis dokumen Accurate. Faktur Penjualan dan Penerimaan Barang dapat dihapus setelah pembayaran, retur, atau faktur turunannya dilepas; dokumen serta mutasi aktifnya hilang, stok kembali, dan snapshot tetap tercatat di Log Aktivitas. Transfer Gudang dan Penyesuaian Persediaan yang Posted tidak dihapus langsung, tetapi dibatalkan dengan mutasi pembalik."] },
