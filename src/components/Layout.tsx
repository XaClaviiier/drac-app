...
const desktopGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Jurnal Umum", path: "/general-journal", icon: Table2, perm: "report:view", tone: "green" },
      ...
      { label: "Histori Akun", path: "/general-ledger", icon: History, perm: "report:view", tone: "purple" },
      { label: "Saldo Awal", path: "/opening-balances", icon: BookOpen, perm: "settings:edit", tone: "purple" },
    ...
    <div className="flex h-[100dvh] overflow-hidden bg-gray-100 lg:h-screen">
      ...
      {desktopMenuOpen &&
        (() => {
          ...
          // top-12 rounded-r-xl is the legacy baseline; actual offset is top-[112px].
      ...
      <div className="flex flex-1 flex-col overflow-hidden lg:pt-12">
        ...
        <div className={`${ui.workspaceBar} relative z-[70] ${location.pathname === "/chart-of-accounts" ? "flex" : "hidden lg:flex"}`}>
