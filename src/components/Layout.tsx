...
const desktopGroups = [
  ...
  { id: 'inventory', label: 'Persediaan', icon: Boxes, items: [
    ...
    { label: 'Penyesuaian Stok', path: '/opening-stock', icon: Upload, perm: 'item:edit', tone: 'green' },
  ...
  return (
    <div className="flex h-[100dvh] overflow-hidden bg-gray-100 lg:h-screen">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <main className={`flex-1 ${location.pathname === '/ai' ? 'overflow-hidden p-0 pb-[64px] lg:overflow-y-auto lg:p-6 lg:pb-6' : location.pathname === '/' ? 'overflow-y-auto p-0 lg:p-6' : location.pathname.startsWith('/receipts') || location.pathname === '/items' ? 'overflow-y-auto p-0 pb-24 lg:pb-0' : 'overflow-y-auto p-3 pb-24 sm:p-6 lg:pb-6'}`}>
          <Outlet />
        </main>
        {location.pathname !== '/' && (
