...
import { Banknote, Bell, Bot, Boxes, Building2, Car, ChevronDown, CirclePlus, FileText, Grid2X2, Home, LogOut, PackagePlus, Settings, Sparkles, Users, Wrench, X, FolderTree, ReceiptText, Shield } from 'lucide-react';
