...
export default function MobileDashboard(){
  ...
  return <div className="min-h-screen bg-[#031a35] pb-24 text-white lg:hidden">
    ...
    <div className="relative mx-auto max-w-md px-4 pb-6 pt-[max(18px,env(safe-area-inset-top))]">
      ...
      <section className="mt-4 grid grid-cols-2 gap-3">{hasPermission('wo:create')&&<button onClick={()=>goTransaction('/workorders')} className="flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-orange-400 to-orange-600 py-4 font-bold shadow-lg shadow-orange-900/20"><Wrench/>Buat WO</button>}{hasPermission('invoice:create')&&<button onClick={()=>goTransaction('/invoices')} className="flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-emerald-400 to-green-600 py-4 font-bold shadow-lg shadow-green-900/20"><FileText/>Buat Faktur</button>}</section>
