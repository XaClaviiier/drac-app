...
export default function SalesReport() {
  ...
  return <div className="space-y-3 pb-4">
    ...
    <div className="flex flex-wrap items-center gap-2 border-b border-blue-200 pb-2">
      ...
      <input type="date" value={from} onChange={e => setFrom(e.target.value)} className="h-9 rounded-lg border px-2 text-sm"/><input type="date" value={to} onChange={e => setTo(e.target.value)} className="h-9 rounded-lg border px-2 text-sm"/>
