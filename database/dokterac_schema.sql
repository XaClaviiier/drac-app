...
CREATE TABLE IF NOT EXISTS `vehicles` (
  ...
  `generation_name` VARCHAR(100) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `work_orders` (
  ...
  `diagnosis_hp` DECIMAL(8,2) DEFAULT NULL,
  `final_temperature` DECIMAL(6,2) DEFAULT NULL,
  `final_lp` DECIMAL(8,2) DEFAULT NULL,
  `final_hp` DECIMAL(8,2) DEFAULT NULL,
  ...
  `continued_by` VARCHAR(64) DEFAULT NULL,
  `continued_by_name` VARCHAR(150) DEFAULT NULL,
  `continued_branch_id` VARCHAR(20) DEFAULT NULL,
  `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
